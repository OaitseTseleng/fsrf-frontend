...
import { CookieItem } from '@/components/features/menu/types/menu.d';

interface CookieCardProps {
  item: CookieItem;
}

export default function CookieCard({ item }: CookieCardProps) {
  return (
    <div className="group relative h-96 rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500">
      {/* Cookie Image with Gradient Overlay */}
